    ...
    <section className="relative flex h-screen flex-col items-center sm:min-h-screen sm:h-auto sm:pb-[60px]">
      ...
      <div className="relative flex w-full max-w-[1200px] flex-col items-start px-4 sm:px-6 sm:gap-[48px] lg:px-0">
        ...
        <div className="flex w-full flex-col gap-[20px] items-start sm:gap-[32px] lg:w-[800px]">
          ...
          {/* Text */}
          <div className="flex w-full flex-col gap-[12px] items-start text-white sm:order-1 sm:gap-[16px]">
            <h1 className="font-[family-name:var(--font-graphik)] text-[40px] leading-[1.05] tracking-[-1.2px] sm:text-[56px] sm:tracking-[-1.8px] lg:text-[80px] lg:tracking-[-2.4px]">
              Los Angeles Movers You Can Actually Count On
            </h1>
            <p className="w-[304px] text-[18px] font-medium leading-[1.4] opacity-90 sm:w-full sm:text-[22px] sm:opacity-100 lg:w-[680px]">
      ...
      {/* Mobile Form — simplified bar */}
      <div className="relative z-10 flex h-[72px] w-full shrink-0 items-center border-t border-[rgba(255,255,255,0.1)] bg-[rgba(0,0,0,0.8)] backdrop-blur-[12px] sm:hidden">
        <div className="flex h-full flex-1 items-center gap-[20px] overflow-hidden pl-[16px] pr-[20px]">
          ...
          {/* Road with truck */}
          <div className="relative flex h-[39px] w-[112px] shrink-0 flex-col items-center justify-end pb-[12px]">
            <svg
              width={32}
              height={32}
              viewBox="0 0 24 24"
